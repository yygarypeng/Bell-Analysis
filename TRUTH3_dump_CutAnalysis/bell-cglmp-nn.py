...
os.environ[
    "CUDA_DEVICE_ORDER"
] = "PCI_BUS_ID"  # If the line below doesn't work, uncomment this line (make sure to comment the line below); it should help.
...
model = KerasRegressor(
    model=build_model, epochs=5, node=16, drop_rate=0.3, learning_rate=0.001
)
